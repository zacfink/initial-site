  ...
  "work": {
    ...
    "featured": [
      ...
      },
      {
        ...
        "desc": "Turns my Supabase backends into spreadsheet and JSON files on my Mac. Save a file and the site updates, so an AI agent can run a backend just by editing files.",
        "meta": "Electron · JavaScript",
        "repo": "https://github.com/zacfink/SupaBaseFolder"
      }
    ]
  },
  "monthly": {
